<?php $attributes = array('class' => 'form-signin', 'role'=> 'form', 'id' => 'login', 'style' => 'background:#434343 !important;'); ?>
...
<?=form_open('login', $attributes)?>
        ...
        <?php } ?>
          ...
          <div class="form-group">
            <label for="username" style="color:#fff !important"><?=$this->lang->line('application_username');?></label>
            <input type="username" class="form-control" id="username" name="username" />
          </div>
          <div class="form-group">
            <label for="password" style="color:#fff !important"><?=$this->lang->line('application_password');?></label>
